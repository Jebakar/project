                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  >
                    ...
                    {shoesDropdownOpen && (
                      ...
                      >
                        <li><Link className="dropdown-item" to="/shoes/best">Best Shoes</Link></li>
                        <li><Link className="dropdown-item" to="/shoes/stylish">Stylish Shoes</Link></li>
                        <li><Link className="dropdown-item" to="/shoes/casual">Casual Shoes</Link></li>
                        <li><Link className="dropdown-item" to="/shoes/running">Running Shoes</Link></li>
                        <li><Link className="dropdown-item" to="/shoes/comfort">Comfort Shoes</Link></li>
                        <li><Link className="dropdown-item" to="/shoes/sports">Sports Shoes</Link></li>
                      </ul>
                    )}
                  </li>
